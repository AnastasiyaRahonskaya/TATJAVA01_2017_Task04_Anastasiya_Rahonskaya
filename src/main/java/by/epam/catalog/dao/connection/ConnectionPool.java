...
public class ConnectionPool {
  ...
  private void clearConnectionQueue() {
    try {
      ...
      System.out.println("Exception in clearConnectionQueue.");
    }
  }
  ...
  public void closeConnection(Connection con, PreparedStatement ps, ResultSet rs) {
    try {
      ...
      System.out.println("Exception in closeConnection con.");
    }
    try {
      rs.close();
    } catch (SQLException e) {
      System.out.println("Exception in closeConnection rs");
    }
    try {
      ps.close();
    } catch (SQLException e) {
      System.out.println("Exception in closeConnection st");
    }
  }
